...
public:
	 ...
	 * @param gp2 GPIO PAD for 1st LED - 1
	 * @param gp3 GPIO PAD for 1st LED - 2
	 * @param gp4 GPIO PAD for 1st LED - 3
	 * @param gp5 GPIO PAD for 1st LED - 4
	 * @param gp6 GPIO PAD for 1st LED - 5
	 * @param gp7 GPIO PAD for 1st LED - 6
	 */
